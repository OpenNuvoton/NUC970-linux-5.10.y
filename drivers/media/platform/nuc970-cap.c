...
/*
 * NUC970 Camera Capture Interface Controller (CCAP) driver
 *
...
/* nuc970_ccap display ioctl operations */
...
static const struct of_device_id ccap_of_match[] = {
	{.compatible = "nuvoton,nuc970-ccap" },
	{ },
};

static struct platform_driver __refdata nuc970_ccap = {
	.probe = ccap_probe,
	.remove = ccap_remove,
	.driver = {
		   .name = "nuc970-cap",
...
module_platform_driver_probe(nuc970_ccap, ccap_probe);

MODULE_DESCRIPTION("NUC970 CCAP driver");
MODULE_LICENSE("GPL v2");
MODULE_VERSION("1.0.0");
MODULE_ALIAS("platform:nuc970-ccap");
