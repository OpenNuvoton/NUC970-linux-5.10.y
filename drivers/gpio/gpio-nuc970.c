...
static int nuc970_gpio_of_xlate(struct gpio_chip *gc,
...
static int nuc970_gpio_probe(struct platform_device *pdev)
{
...
#endif
	{
		...
		nuc970_gpio_port.of_node = pdev->dev.of_node;
		nuc970_gpio_port.of_xlate = nuc970_gpio_of_xlate;
		nuc970_gpio_port.of_gpio_n_cells = 2;
#endif
...
static int nuc970_gpio_remove(struct platform_device *pdev)
{
	...
	if (gpio_ba) {
		gpiochip_remove(&nuc970_gpio_port);
