...
#define REG_TSCTL 		(void __iomem *)0xF0003100
#define REG_TSSEC 		(void __iomem *)0xF0003110 /* [31:0] */
#define REG_TSSUBSEC 	(void __iomem *)0xF0003114 /* [30:0] */
#define REG_TSINC 		(void __iomem *)0xF0003118
#define REG_TSADDEND 	(void __iomem *)0xF000311c
#define REG_UPDSEC 		(void __iomem *)0xF0003120
#define REG_UPDSUBSEC 	(void __iomem *)0xF0003124
#define REG_ALMSEC 		(void __iomem *)0xF0003128
#define REG_ALMSUBSEC 	(void __iomem *)0xF000311c
...
static void __init get_mac_address(struct net_device *netdev)
{
	...
	if (is_valid_ether_addr(nuc970_mac1))
		memcpy(netdev->dev_addr, &nuc970_mac1[0], 0x06);
	else
